function gkgammatst(x,alpha,tail)
...
assignin ('base', 'g', g); % these 2 lines will save the correlation and SE (don't really need) as variables
assignin ('base', 'GKasymototicSE', se);
assignin ('base', 'significance', sig);
...
% just note the format that the input x needs to be in:

% if this is your data table:

% confidence | # of wrong responses | # of right responses
% ----------------------------------------------------------
      % 1    |          12          |           3 
      % 2    |          8           |           6
      % 3    |          4           |           2
...
% then x for your input would be:
